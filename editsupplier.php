...
?>
             <div class="col-lg-12">
                  <h2>Edit Records</h2>
                      <div class="col-lg-6">
                        <form role="form" method="post" action="edit1supplier.php">
                            <div class="form-group">
                              <input class="form-control" placeholder="Manufacturer ID" name="Manufacturer_ID" value="<?php echo $i; ?>"readonly>
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Manufacturer Name" name="Manufacturer_Name" value="<?php echo $a; ?>"required>
                            </div> 
