                      ...
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="transacproduct.php?action=add">
                            ...
                            <div class="form-group">
                              <input class="form-control" hidden placeholder="Product ID" name="prod_id">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="Product Code" name="prod_code" type="number" required>
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Product Name" name="prod_name" required>
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Brand Name" name="brand_name" required>
                            </div>
                            <div class="form-group">
